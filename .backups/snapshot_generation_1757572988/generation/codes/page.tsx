  ...
  return (
    <div className={`${styles.theme} p-6 space-y-4`}>
      <div className="flex items-center justify-between">
        <div className={styles.tabs}><a href="/generation" className={styles.tab}>Генерация</a><a href="/generation/codes" className={`${styles.tab} ${styles.tabActive}`}>Коды</a></div>
