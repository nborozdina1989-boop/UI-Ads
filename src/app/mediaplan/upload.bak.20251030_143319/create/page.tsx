    ...
    <div className="p-0">
      <div className="border-b bg-white px-6 pt-6">
        ...
        <div className="flex gap-2">
          <Link href="/mediaplan/upload" className="px-4 py-2 rounded-t-lg border-b-2 border-transparent text-slate-600 hover:text-slate-800">
            Загрузить медиаплан
          </Link>
          <span className="px-4 py-2 rounded-t-lg border-b-2 border-[#0078D7] text-[#0078D7]">
            Создать медиаплан
          </span>
        </div>
      </div>
